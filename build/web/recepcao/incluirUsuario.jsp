        ...
        <div id="content">
            ...
            <article class="box post post-excerpt">
                ...
                <div style="padding: 30px;">
                    <form method="POST" action="salvarUsuario.jsp" style="padding: 30px">
                        <table style="color: black; font-weight: bold;">
                            <tr style="text-align: center">
                                <td colspan="2"><h2>Dados do Usuário</h2></td>
                            </tr>
                            <tr>
                                <td>Nome</td>
                                <td>
                                    <input style="background-color: silver" type="text" name="nome" size="50" required>
                                </td>
                            </tr>
                            <tr>
                                <td>Email</td>
                                <td>
                                    <input style="background-color: silver" type="text" name="email" size="50" required>
                                </td>
                            </tr>
                            <tr>
                                <td>Senha</td>
                                <td>
                                    <input style="background-color: silver" type="password" name="senha" size="50" required>
                                </td>
                            </tr>
                            <tr>
                                <td>Tipo de Usuário</td>
                                <td>
                                    <select style="background-color: silver" id="country" name="tipo">
                                        <option value="aluno">Aluno</option>
                                        <option value="instrutor">Instrutor</option>
                                        <option value="administrador">Secretaria/Recepção</option>
        ...
        <div id="sidebar" style="background-color: #1571E9;">
            ...
            <nav id="nav">
                <ul>
                    ...
                    <li><a href="incluirParcela.jsp">Gerar</a></li>
                    ...
                    <li><a href="listarUsuario.jsp">Consultar</a></li>
                    ...
                    <li><a href="consultarApostila.jsp">Listar</a></li>                    
                </ul>
            </nav>
