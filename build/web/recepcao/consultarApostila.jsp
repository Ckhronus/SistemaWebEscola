               ...
               ResultSet res = comando.executeQuery();
                ...
                <div style="background-color: #80bdff; font-weight: bolder;">
                    ...
                    <table id="minhaTabela" style="border: 1px solid black;">
                        <thead>
                            <tr>
                                <th>CÓDIGO</th><th>NOME</th><th>Quantidade</th><th>Entregar</th><th>Excluir</th>
                            </tr>
                        </thead>
                        <tbody>
                            <%
                                while (res.next()) {
                                    ...
                                    out.println("<td>" + res.getInt("quantidade") + "</td>");
                                    
                                    out.println("<td><a href=excluirApostila.jsp?id="+ 
                                            res.getInt("id") + "><button type='button' >Entregar</button></a>");
                                    out.println("<td><a href=excluirApostilaGeral.jsp?id="+ 
