    ...
    <body class="is-preload">
        ...
        <div id="content">
            ...
            <article class="box post">
                ...
                String sql = "SELECT p.id, p.valor, p.pago, p.vencimento, p.data_pagamento, u.nome, u.id "
                        + "FROM parcela p "
                ...
                <div style="background-color: #80bdff; font-weight: bolder;">
                    ...
                    <table id="minhaTabela" style="border: 1px solid black;">
                        <thead>
                            <tr>
                                <th>Código da Parcela</th><th>Valor</th><th>Vencimento</th><th>Pagamento</th>
                                <th>Aluno</th>
                            </tr>
                        </thead>
                        <tbody>
                            <%
                                while (res.next()) {
                                    ...
                                    out.println("<td>" + res.getString("data_pagamento") + "</td>");
