        ...
        <div id="content">
            ...
            <article class="box post post-excerpt">
                ...
                <div style="padding: 30px;">
                    <form method="POST" action="salvarFaltas.jsp" style="padding: 30px">
                        <table style="color: black; font-weight: bold;">
                            <tr style="text-align: center">
                                <td colspan="2"><h2>Dados do Aluno</h2></td>
                            </tr>
                            <tr>
                                <td>Matrícula do Aluno</td>
                                <td>
                                    <input style="background-color: silver" type="text" name="matricula" size="50" required>
                                </td>
                            </tr>
                            <tr>
                                <td>Número de Faltas</td>
                                <td>
                                    <input style="background-color: silver" type="text" name="faltas" size="50" required>
                                </td>
                            </tr>
                            <tr>
