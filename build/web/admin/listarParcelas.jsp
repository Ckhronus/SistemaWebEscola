    ...
    <body class="is-preload">
        ...
        <div id="content">
            ...
            <article class="box post">
                ...
                String sql = "SELECT p.id, p.valor, p.pago, p.vencimento, u.nome, u.id FROM parcela p INNER JOIN usuario u ON p.id_aluno_parcela = u.id WHERE pago = false;";
                ...
                <div style="background-color: #80bdff; font-weight: bolder;">
                    ...
                    <table id="minhaTabela" style="border: 1px solid black;">
                        <thead>
                            <tr>
                                <th>Código da Parcela</th><th>Valor</th><th>Vencimento</th>
                                <th>Aluno</th><th>Opções</th>
                            </tr>
                        </thead>
                        <tbody>
                            <%
                                ...
                                while (res.next()) {
                                    ...
                                    out.println("<td>" + res.getInt("p.id") + "</td>");
                                    out.println("<td>" + df.format(res.getDouble("p.valor")) + "</td>");
                                    out.println("<td>" + res.getString("p.vencimento") + "</td>");
                                    out.println("<td>" + res.getString("u.nome") + "</td>");
                                    out.println("<td><a href=incluirParcelasPagas.jsp?idUsuario="+res.getInt("u.id")+"><button type='button' style='background-color: green' >Pagamento</button></a>");
                                    out.println("</tr>");
