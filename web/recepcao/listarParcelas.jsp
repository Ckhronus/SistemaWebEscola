    ...
    <body class="is-preload">
        ...
        <div id="content">
            ...
            <article class="box post">
                ...
                String sql = "SELECT p.id, p.valor, p.pago, p.vencimento, u.nome, u.id "
                        + "FROM parcela p "
                        ...
                        <tbody>
                            <%
                                ...
                                while (res.next()) {
                                    ...
                                    out.println("<td>" + df.format(res.getDouble("valor")) + "</td>");
                                    out.println("<td>" + res.getString("vencimento") + "</td>");
