        ...
        <div id="content">
            ...
            <article class="box post">
                ...
                <div style="font-weight: bolder;">
                    <form method="POST" action="mostrarApostila.jsp">
                        <table style="color: black" >
                            <tr>
                                <td>Nome da Apostila</td> 
                            </tr>
                            <tr>
                                <td><input name="nomeApostila" type="text" id="nomeApostila" required></td>
                            </tr>
                            <tr>
