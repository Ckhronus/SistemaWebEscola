    ...
    <body class="is-preload">
        ...
        <div id="content">
            ...
            <article class="box post">
                ...
                String sql = "SELECT u.id, u.nome, f.id_aluno_faltas, f.data_falta, f.faltas "
                        + "FROM faltas f "
                        + "INNER JOIN usuario u "
                        + "ON u.id = id_aluno_faltas "
                        + "WHERE id_aluno_faltas = (select id from usuario where nome = ? limit 1);";
                ...
                <div style="background-color: #80bdff; font-weight: bolder;">
                    ...
                    <table id="minhaTabela" style="border: 1px solid black;">
                        <thead>
                            <tr>
                                <th>ID Aluno</th><th>Aluno</th><th>Faltas</th><th>Data da Falta</th>
                            </tr>
                        </thead>
                        <tbody>
                            <%
